...
class MessageBuilder {
    ...
    private static final String LIBRARY_LABEL = " => ";
    ...
    String buildObservableInfoMessage(ObservableInfo observableInfo) {
        final LogRxJoinPoint joinPoint = observableInfo.getJoinPoint();
    ...
    String buildObservableItemTimeInfoMessage(ObservableInfo observableInfo) {
        final int totalEmittedItems = observableInfo.getTotalEmittedItems().orElse(0);
        final long totalExecutionTime = observableInfo.getTotalExecutionTime().orElse(0L);
        final StringBuilder message = buildObservableSB();
        message.append(METHOD_SEPARATOR);
        message.append(observableInfo.getMethodName());
        message.append(VALUE_SEPARATOR);
    ...
    private String buildMethodSignatureWithValues(LogRxJoinPoint joinPoint) {
        final int avg = 30;
