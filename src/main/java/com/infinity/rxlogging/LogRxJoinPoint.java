...
/**
 * Wrapper around {@link JoinPoint} to make easy retrieve data from a certain
 * {@link JoinPoint} passed as a parameter in the constructor.
 */
public class LogRxJoinPoint {
   ...
   */
  public LogRxJoinPoint(JoinPoint joinPoint) {
    if (joinPoint == null) {
   ...
   *
   * @param annotation The {@link Annotation} to get.
  ...
  public boolean equals(Object object) {
    ...
    LogRxJoinPoint joinPoint = (LogRxJoinPoint) object;
